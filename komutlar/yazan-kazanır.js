...
const words = ['çikolata', 'chaos', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek'];
...
exports.run = async (client, msg, args) => {
  ...
  if (opponent.bot) return msg.reply('Botlar ile oynayamazsın!');
	...
	exports.conf = {
	  ...
	  guildOnly: true,
	  aliases: ["yaz-kazan"],
	  kategori: "yazan-kazanır",
	  permLevel: 0
	};
	exports.help = {
	  name: "yazan-kazanır",
	  description: "yazan-kazanır",
	  usage: "yazan-kazanır"
	};